...
export const currentFlowFqnAtom = atom<string | null>(null) as WritableAtom<string | null, [string | null], void>;
export const systemViewActiveAtom = atom<boolean>(false) as WritableAtom<boolean, [boolean], void>;
export const currentModeAtom = atom<VisualizerModeEnum>('design') as WritableAtom<VisualizerModeEnum, [VisualizerModeEnum], void>;
export const currentDesignViewModeAtom = atom<DesignViewModeEnum>('flowDetail') as WritableAtom<DesignViewModeEnum, [DesignViewModeEnum], void>;
