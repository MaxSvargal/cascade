...
export const traceListSummariesAtom = atom<HistoricalFlowInstanceSummary[]>([]) as WritableAtom<HistoricalFlowInstanceSummary[], [HistoricalFlowInstanceSummary[]], void>;

// Currently selected trace ID
export const selectedTraceIdAtom = atom<string | null>(null) as WritableAtom<string | null, [string | null], void>;

// Trace list loading state
export const traceListLoadingAtom = atom<boolean>(false) as WritableAtom<boolean, [boolean], void>;

// Trace list error state
export const traceListErrorAtom = atom<string | null>(null) as WritableAtom<string | null, [string | null], void>;
